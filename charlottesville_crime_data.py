...
row1[1].metric("Incidents Last 6 Months", incidents_last_6_months)
row1[2].metric("Incidents This Quarter", incidents_this_quarter)
row1[3].metric("Incidents Last Month", incidents_last_month)
